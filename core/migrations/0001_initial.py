    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.IntegerField(default=1, choices=[(1, b'Empresa'), (2, b'Cliente')])),
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('pode_criar_vaga', 'Pode criar Vaga'),),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.ForeignKey(to='core.Empresa')),
                ('perfil', models.OneToOneField(to='core.PerfilProfissional')),
            ],
        ),
    ]
